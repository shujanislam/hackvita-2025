...
const users = [
    { id: 'abc123', name: "Alice", interests: ["technology", "AI", "coding"], watchHistory: ["Intro to AI", "Building Chatbots"] },
    { id: 'xyz123', name: "Bob", interests: ["gaming", "streaming", "VR"], watchHistory: ["Top 10 VR Games", "Best Streaming Setups"] },
];
...
async function getRecommendationResponse(userId) {
    try {
        ...
        const inputData = `
        You are a video recommendation system. Based on the user's interests and watch history, 
        suggest the best videos from the provided list. Explain why each video is relevant.
